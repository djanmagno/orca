...
export type PersistedUIState = {
  ...
  /** One-shot flag for clearing cleanup filters a wheel tick could have set without the user knowing; see _neutralizeWorkspaceCleanupFilters in the load path. */
  _workspaceCleanupFiltersNeutralized?: boolean
